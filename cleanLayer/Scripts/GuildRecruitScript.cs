...
namespace cleanLayer.Scripts
{
    public class GuildRecruitmentScript : Script
    {
        ...
        public Dictionary<string, Character> InvitedCharacters = new Dictionary<string, Character>();
        ...
        private string RecruitMessage = "Hello! Why don't you have a guild? Join the social guild <In my humble opinion> for perks like extra XP and other fun stuff! :)";
        ...
        {
            Events.Remove("WHO_LIST_UPDATE", HandleEvent);
        }
