    ...
    public class WoWObject
    {
        ...
        public WoWObject(IntPtr pointer)
        {
            ...
            if (IsValid)
            {
                ...
                _getObjectFacing = RegisterVirtualFunction<GetObjectFacingDelegate>(4*14);
        ...
        public string Name
        {
            get
            {
                ...
                if (pointer == IntPtr.Zero)
                    return "UNKNOWN";
                return Helper.Magic.Read<string>(pointer);
            }
        }
        ...
        public float Facing
        {
            get
            {
                var facing = _getObjectFacing(Pointer);
                return facing;
            }
        }
        ...
        public static implicit operator IntPtr(WoWObject self)
        {
            return self != null ? self.Pointer : IntPtr.Zero;
        }

        public static WoWObject Invalid = new WoWObject(IntPtr.Zero);
    }
}