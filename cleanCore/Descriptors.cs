namespace cleanCore
{
    ...
    public enum UnitField : uint
    {
        ...
        UNIT_FIELD_MAXHEALTH = ObjectField.OBJECT_END + 0x60,
        UNIT_FIELD_MAXPOWER1 = ObjectField.OBJECT_END + 0x64,
        UNIT_FIELD_MAXPOWER2 = ObjectField.OBJECT_END + 0x68,
        UNIT_FIELD_MAXPOWER3 = ObjectField.OBJECT_END + 0x6C,
        UNIT_FIELD_MAXPOWER4 = ObjectField.OBJECT_END + 0x70,
        UNIT_FIELD_MAXPOWER5 = ObjectField.OBJECT_END + 0x74,
        UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER = ObjectField.OBJECT_END + 0x78,
        UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER = ObjectField.OBJECT_END + 0x8C,
        UNIT_FIELD_LEVEL = ObjectField.OBJECT_END + 0xA0,
        UNIT_FIELD_FACTIONTEMPLATE = ObjectField.OBJECT_END + 0xA4,
        UNIT_VIRTUAL_ITEM_SLOT_ID = ObjectField.OBJECT_END + 0xA8,
        UNIT_FIELD_FLAGS = ObjectField.OBJECT_END + 0xB4,
        UNIT_FIELD_FLAGS_2 = ObjectField.OBJECT_END + 0xB8,
        UNIT_FIELD_AURASTATE = ObjectField.OBJECT_END + 0xBC,
        UNIT_FIELD_BASEATTACKTIME = ObjectField.OBJECT_END + 0xC0,
        UNIT_FIELD_RANGEDATTACKTIME = ObjectField.OBJECT_END + 0xC8,
        UNIT_FIELD_BOUNDINGRADIUS = ObjectField.OBJECT_END + 0xCC,
        UNIT_FIELD_COMBATREACH = ObjectField.OBJECT_END + 0xD0,
        UNIT_FIELD_DISPLAYID = ObjectField.OBJECT_END + 0xD4,
        UNIT_FIELD_NATIVEDISPLAYID = ObjectField.OBJECT_END + 0xD8,
        UNIT_FIELD_MOUNTDISPLAYID = ObjectField.OBJECT_END + 0xDC,
        UNIT_FIELD_MINDAMAGE = ObjectField.OBJECT_END + 0xE0,
        UNIT_FIELD_MAXDAMAGE = ObjectField.OBJECT_END + 0xE4,
        UNIT_FIELD_MINOFFHANDDAMAGE = ObjectField.OBJECT_END + 0xE8,
        UNIT_FIELD_MAXOFFHANDDAMAGE = ObjectField.OBJECT_END + 0xEC,
        UNIT_FIELD_BYTES_1 = ObjectField.OBJECT_END + 0xF0,
        UNIT_FIELD_PETNUMBER = ObjectField.OBJECT_END + 0xF4,
        UNIT_FIELD_PET_NAME_TIMESTAMP = ObjectField.OBJECT_END + 0xF8,
        UNIT_FIELD_PETEXPERIENCE = ObjectField.OBJECT_END + 0xFC,
        UNIT_FIELD_PETNEXTLEVELEXP = ObjectField.OBJECT_END + 0x100,
        UNIT_DYNAMIC_FLAGS = ObjectField.OBJECT_END + 0x104,
        UNIT_MOD_CAST_SPEED = ObjectField.OBJECT_END + 0x108,
        UNIT_MOD_CAST_HASTE = ObjectField.OBJECT_END + 0x10C,
        UNIT_CREATED_BY_SPELL = ObjectField.OBJECT_END + 0x110,
        UNIT_NPC_FLAGS = ObjectField.OBJECT_END + 0x114,
        UNIT_NPC_EMOTESTATE = ObjectField.OBJECT_END + 0x118,
        UNIT_FIELD_STAT0 = ObjectField.OBJECT_END + 0x11C,
        UNIT_FIELD_STAT1 = ObjectField.OBJECT_END + 0x120,
        UNIT_FIELD_STAT2 = ObjectField.OBJECT_END + 0x124,
        UNIT_FIELD_STAT3 = ObjectField.OBJECT_END + 0x128,
        UNIT_FIELD_STAT4 = ObjectField.OBJECT_END + 0x12C,
        UNIT_FIELD_POSSTAT0 = ObjectField.OBJECT_END + 0x130,
        UNIT_FIELD_POSSTAT1 = ObjectField.OBJECT_END + 0x134,
        UNIT_FIELD_POSSTAT2 = ObjectField.OBJECT_END + 0x138,
        UNIT_FIELD_POSSTAT3 = ObjectField.OBJECT_END + 0x13C,
        UNIT_FIELD_POSSTAT4 = ObjectField.OBJECT_END + 0x140,
        UNIT_FIELD_NEGSTAT0 = ObjectField.OBJECT_END + 0x144,
        UNIT_FIELD_NEGSTAT1 = ObjectField.OBJECT_END + 0x148,
        UNIT_FIELD_NEGSTAT2 = ObjectField.OBJECT_END + 0x14C,
        UNIT_FIELD_NEGSTAT3 = ObjectField.OBJECT_END + 0x150,
        UNIT_FIELD_NEGSTAT4 = ObjectField.OBJECT_END + 0x154,
        UNIT_FIELD_RESISTANCES = ObjectField.OBJECT_END + 0x158,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE = ObjectField.OBJECT_END + 0x174,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE = ObjectField.OBJECT_END + 0x190,
        UNIT_FIELD_BASE_MANA = ObjectField.OBJECT_END + 0x1AC,
        UNIT_FIELD_BASE_HEALTH = ObjectField.OBJECT_END + 0x1B0,
        UNIT_FIELD_BYTES_2 = ObjectField.OBJECT_END + 0x1B4,
        UNIT_FIELD_ATTACK_POWER = ObjectField.OBJECT_END + 0x1B8,
        UNIT_FIELD_ATTACK_POWER_MOD_POS = ObjectField.OBJECT_END + 0x1BC,
        UNIT_FIELD_ATTACK_POWER_MOD_NEG = ObjectField.OBJECT_END + 0x1C0,
        UNIT_FIELD_ATTACK_POWER_MULTIPLIER = ObjectField.OBJECT_END + 0x1C4,
        UNIT_FIELD_RANGED_ATTACK_POWER = ObjectField.OBJECT_END + 0x1C8,
        UNIT_FIELD_RANGED_ATTACK_POWER_MOD_POS = ObjectField.OBJECT_END + 0x1CC,
        UNIT_FIELD_RANGED_ATTACK_POWER_MOD_NEG = ObjectField.OBJECT_END + 0x1D0,
        UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER = ObjectField.OBJECT_END + 0x1D4,
        UNIT_FIELD_MINRANGEDDAMAGE = ObjectField.OBJECT_END + 0x1D8,
        UNIT_FIELD_MAXRANGEDDAMAGE = ObjectField.OBJECT_END + 0x1DC,
        UNIT_FIELD_POWER_COST_MODIFIER = ObjectField.OBJECT_END + 0x1E0,
        UNIT_FIELD_POWER_COST_MULTIPLIER = ObjectField.OBJECT_END + 0x1FC,
        UNIT_FIELD_MAXHEALTHMODIFIER = ObjectField.OBJECT_END + 0x218,
        UNIT_FIELD_HOVERHEIGHT = ObjectField.OBJECT_END + 0x21C,
        UNIT_FIELD_MAXITEMLEVEL = ObjectField.OBJECT_END + 0x220,
        UNIT_FIELD_PADDING = ObjectField.OBJECT_END + 0x224,
        UNIT_END = ObjectField.OBJECT_END + 0x228
    }

    // Descriptors: 0x00CE0DC8
    ...
    public enum PlayerField : uint
    {
        ...
        PLAYER_FARSIGHT = UnitField.UNIT_END + 0x768,
        PLAYER__FIELD_KNOWN_TITLES = UnitField.UNIT_END + 0x770,
        PLAYER__FIELD_KNOWN_TITLES1 = UnitField.UNIT_END + 0x778,
        PLAYER__FIELD_KNOWN_TITLES2 = UnitField.UNIT_END + 0x780,
        PLAYER_XP = UnitField.UNIT_END + 0x788,
        PLAYER_NEXT_LEVEL_XP = UnitField.UNIT_END + 0x78C,
        PLAYER_SKILL_INFO_1_1 = UnitField.UNIT_END + 0x790,
        PLAYER_CHARACTER_POINTS = UnitField.UNIT_END + 0xD90,
        PLAYER_TRACK_CREATURES = UnitField.UNIT_END + 0xD94,
        PLAYER_TRACK_RESOURCES = UnitField.UNIT_END + 0xD98,
        PLAYER_EXPERTISE = UnitField.UNIT_END + 0xD9C,
        PLAYER_OFFHAND_EXPERTISE = UnitField.UNIT_END + 0xDA0,
        PLAYER_BLOCK_PERCENTAGE = UnitField.UNIT_END + 0xDA4,
        PLAYER_DODGE_PERCENTAGE = UnitField.UNIT_END + 0xDA8,
        PLAYER_PARRY_PERCENTAGE = UnitField.UNIT_END + 0xDAC,
        PLAYER_CRIT_PERCENTAGE = UnitField.UNIT_END + 0xDB0,
        PLAYER_RANGED_CRIT_PERCENTAGE = UnitField.UNIT_END + 0xDB4,
        PLAYER_OFFHAND_CRIT_PERCENTAGE = UnitField.UNIT_END + 0xDB8,
        PLAYER_SPELL_CRIT_PERCENTAGE1 = UnitField.UNIT_END + 0xDBC,
        PLAYER_SHIELD_BLOCK = UnitField.UNIT_END + 0xDD8,
        PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE = UnitField.UNIT_END + 0xDDC,
        PLAYER_MASTERY = UnitField.UNIT_END + 0xDE0,
        PLAYER_EXPLORED_ZONES_1 = UnitField.UNIT_END + 0xDE4,
        PLAYER_REST_STATE_EXPERIENCE = UnitField.UNIT_END + 0x1024,
        PLAYER_FIELD_COINAGE = UnitField.UNIT_END + 0x1028,
        PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UnitField.UNIT_END + 0x1030,
        PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UnitField.UNIT_END + 0x104C,
        PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UnitField.UNIT_END + 0x1068,
        PLAYER_FIELD_MOD_HEALING_DONE_POS = UnitField.UNIT_END + 0x1084,
        PLAYER_FIELD_MOD_HEALING_PCT = UnitField.UNIT_END + 0x1088,
        PLAYER_FIELD_MOD_HEALING_DONE_PCT = UnitField.UNIT_END + 0x108C,
        PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS = UnitField.UNIT_END + 0x1090,
        PLAYER_FIELD_MOD_SPELL_POWER_PCT = UnitField.UNIT_END + 0x109C,
        PLAYER_FIELD_MOD_TARGET_RESISTANCE = UnitField.UNIT_END + 0x10A0,
        PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = UnitField.UNIT_END + 0x10A4,
        PLAYER_FIELD_BYTES = UnitField.UNIT_END + 0x10A8,
        PLAYER_SELF_RES_SPELL = UnitField.UNIT_END + 0x10AC,
        PLAYER_FIELD_PVP_MEDALS = UnitField.UNIT_END + 0x10B0,
        PLAYER_FIELD_BUYBACK_PRICE_1 = UnitField.UNIT_END + 0x10B4,
        PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UnitField.UNIT_END + 0x10E4,
        PLAYER_FIELD_KILLS = UnitField.UNIT_END + 0x1114,
        PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UnitField.UNIT_END + 0x1118,
        PLAYER_FIELD_BYTES2 = UnitField.UNIT_END + 0x111C,
        PLAYER_FIELD_WATCHED_FACTION_INDEX = UnitField.UNIT_END + 0x1120,
        PLAYER_FIELD_COMBAT_RATING_1 = UnitField.UNIT_END + 0x1124,
        PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UnitField.UNIT_END + 0x118C,
        PLAYER_FIELD_BATTLEGROUND_RATING = UnitField.UNIT_END + 0x11E0,
        PLAYER_FIELD_MAX_LEVEL = UnitField.UNIT_END + 0x11E4,
        PLAYER_FIELD_DAILY_QUESTS_1 = UnitField.UNIT_END + 0x11E8,
        PLAYER_RUNE_REGEN_1 = UnitField.UNIT_END + 0x124C,
        PLAYER_NO_REAGENT_COST_1 = UnitField.UNIT_END + 0x125C,
        PLAYER_FIELD_GLYPH_SLOTS_1 = UnitField.UNIT_END + 0x1268,
        PLAYER_FIELD_GLYPHS_1 = UnitField.UNIT_END + 0x128C,
        PLAYER_GLYPHS_ENABLED = UnitField.UNIT_END + 0x12B0,
        PLAYER_PET_SPELL_POWER = UnitField.UNIT_END + 0x12B4,
        PLAYER_FIELD_RESEARCHING_1 = UnitField.UNIT_END + 0x12B8,
        PLAYER_FIELD_RESERACH_SITE_1 = UnitField.UNIT_END + 0x12D8,
        PLAYER_PROFESSION_SKILL_LINE_1 = UnitField.UNIT_END + 0x12F8,
        PLAYER_FIELD_UI_HIT_MODIFIER = UnitField.UNIT_END + 0x1300,
        PLAYER_FIELD_UI_SPELL_HIT_MODIFIER = UnitField.UNIT_END + 0x1304,
        PLAYER_FIELD_HOME_REALM_TIME_OFFSET = UnitField.UNIT_END + 0x1308,
        PLAYER_FIELD_MOD_HASTE = UnitField.UNIT_END + 0x130C,
        PLAYER_FIELD_MOD_RANGED_HASTE = UnitField.UNIT_END + 0x1310,
        PLAYER_FIELD_MOD_PET_HASTE = UnitField.UNIT_END + 0x1314,
        PLAYER_FIELD_MOD_HASTE_REGEN = UnitField.UNIT_END + 0x1318,
        PLAYER_FIELD_PADDING = UnitField.UNIT_END + 0x131C,
        PLAYER_END = UnitField.UNIT_END + 0x1320
    }

    // Descriptors: 0x00CE1110
    ...
    // Descriptors: 0x00CE3170
    public enum GameObjectField : uint
    {
        GAMEOBJECT_FIELD_CREATED_BY = ObjectField.OBJECT_END,
